...
# The dictionary to decode these is created in [`~/CCU029/auxiliary/lookups/CCACTODE`](https://db.core.data.digital.nhs.uk/#notebook/5445633/command/5445666) and stored in `.ccu029_lkp_ccactcode`
...
lkp_CCACTCODE = spark.sql(
    "SELECT CCACTCODE, Short as CCACTCODE_desc FROM .ccu029_lkp_ccactcode"
)
ccact_skinny = (
...
# MAGIC FROM .ccu029_02_wip_admissions_w_icu
# MAGIC WHERE ICU == 1
